...
class SideBarVC: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        //self.emailLabel.text = "yangjustyle@naver.com"
        ...
        //기본 이미지를 구현한다.
        //let defaultProfiile = UIImage(named: "account.jpg")
        //self.profileImage.image = defaultProfiile

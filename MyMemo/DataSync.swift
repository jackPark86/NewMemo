...
//  MyMemo
//
//  Created by icoinnet on 2022/12/08.
//
...
class DataSync {
    ...
    func uploadData(_ indicatiorView: UIActivityIndicatorView? = nil) {
        //1. 요청 객체 생성
        ...
        do {
            ...
            for record in resultset {
                indicatiorView?.startAnimating() //로딩시작
    ...
    func  uploadDatum(_ item: MemoMO, complete: (()->Void)? = nil) {
        ...
        let upload = AF.request(url, method: .post, parameters: param, encoding: JSONEncoding.default)
